        ...
        <div className="hero-new-content">
          <div className="hero-new-text">
            ...
            <div className="hero-new-cta">
              <a href="https://apps.apple.com/app/id6754100684" target="_blank" rel="noopener noreferrer" className="btn btn-app-store" aria-label={`${t('appStore')} - ${t('download')}`}>
                ...
                <span className="btn-text">
                  ...
                  <span className="btn-sublabel">{t('download')}</span>
                </span>
              </a>
              <a href="https://play.google.com/store/apps/details?id=now.inigo.app" target="_blank" rel="noopener noreferrer" className="btn btn-google-play" aria-label={`${t('googlePlay')} - ${t('download')}`}>
                <span className="btn-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
