      ...
      <div className="container">
        <div className="final-cta-content">
          ...
          <div className="final-cta-buttons">
            <a href="https://apps.apple.com/app/id6754100684" target="_blank" rel="noopener noreferrer" className="btn btn-app-store" aria-label="Download on App Store">
              ...
              <span className="btn-text">
                ...
                <span className="btn-sublabel">Download</span>
              </span>
            </a>
            <a href="https://play.google.com/store/apps/details?id=now.inigo.app" target="_blank" rel="noopener noreferrer" className="btn btn-google-play" aria-label="Download on Google Play">
              <span className="btn-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
